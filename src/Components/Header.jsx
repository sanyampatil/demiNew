...
const Header = () => {
  ...
  return (
    <header
      className={`absolute left-0 top-0 z-20 flex w-full border-2 border-black items-center`}
    >
      <div className='container'>
          ...
          <div className='flex w-full items-center   justify-between px-4'>
            <div>
              <button
                ...
                } absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] rin  g-primary focus:ring-2 lg:hidden  text-black  text-xl `}
              >
                {/* <span className='relative my-[6px] block h-[2px] w-[30px] bg-body-color text-black'></span>
                <span className='relative my-[6px] block h-[2px] w-[30px] bg-body-color text-black'></span>
                <span className='relative my-[6px] block h-[2px] w-[30px] bg-body-color text-black'></span> */}
                <FcMenu />
              </button>
            ...
            <div className='hidden justify-end pr-16 sm:flex lg:pr-0'>
              <a
                href='/#'
                className='px-7 py-3 text-base font-medium text-dark hover:text-primary text-black'
              >
                Sign in
              </a>
              ...
              <a
                href='/#'
                className='rounded-lg bg-primary px-7 py-3 text-base font-medium text-black hover:bg-opacity-90'
              >
                Sign Up
              </a>
            </div>
...
//   return (
//     <div>
//       <h1 className='  bg-orange-400 text-teal-200 '>
//         dbjhdvgdvhjgdvhdgv hdgvghdvhgdvhd
//       </h1>
//     </div>
//   )
// }
